...
const Test = () => {
    ...
    useEffect(() => {
         axios(`http://localhost:4444/questions?category=${params.title}`)
    ...
    const score = Object.values(data).splice( 1).filter((item) => JSON.parse(item).correct  === true).length;
        ...
        axios.post('http://localhost:4444/answers', {...data, point: score, category: params.title,})
    ...
    return (
        <div className={styles.testContainer}>
            ...
            <form onSubmit={handleSubmit(passTest)}>
                ...
                <input {...register('name')} type="text" placeholder='Введите свое имя'/>
